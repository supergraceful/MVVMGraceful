...
import me.magical.graceful.mvvm.viewModel.DownloadVM
import me.magical.graceful.R
import me.magical.graceful.databinding.ActivityDownloadBinding
...
class
DownloadActivity : BaseMVVMAC<ActivityDownloadBinding, DownloadVM>() {

    override fun getLayout() = R.layout.activity_download

    override fun initVariableId() = BR.download
